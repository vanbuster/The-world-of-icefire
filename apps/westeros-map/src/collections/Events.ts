...
export const Events: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "title",
    group: "World Model",
    defaultColumns: ["title", "primaryLocation", "sourceType", "status"],
  },
  fields: [
    ...
    { name: "bookRefLabel", type: "text" },
    { name: "showRefLabel", type: "text" },
    { name: "isBookEvent", type: "checkbox", defaultValue: false },
    { name: "isShowEvent", type: "checkbox", defaultValue: false },
    { name: "isOriginalNote", type: "checkbox", defaultValue: false },
    sourceTypeField,
    canonLevelField,
    statusField,
  ],
